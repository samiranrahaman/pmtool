    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
			 ...
			 <li class="active treeview" >
  			  ...
  			  <a href="#">
  				<i class="fa fa-dashboard"></i> <span>Tools</span> <i class="fa fa-angle-left pull-right"></i>
  			  </a>
				...
				<li class="active treeview">
					  ...
					  <ul class="treeview-menu">
					   <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard "></i>Add</a></li>
					   <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard "></i>Review</a></li>
			  ...
			  <li class="active treeview">
					  ...
					  <ul class="treeview-menu">
					   <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard "></i>To Do</a></li>
					   <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard "></i>Review</a></li>
			  ...
			  <li><a href="<?php echo base_url();?>index.php/dashboard"><i class="fa fa-dashboard "></i>Master View</a></li>
