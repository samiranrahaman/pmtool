...
class Adminuser_model extends CI_Model
{
	...
	public function update_add_user($firstname,$lastname,$phone1,$email,$user_type,$user_id,$password)
	{
	...
	{
		    $sql1="SELECT * from pm_admin a ,pm_authorization_rule b  
			where a.admin_role_id >0
			and a.admin_role_id=b.role_id";
		 $query1= $this->db->query($sql1);
	...
	public function get_idea_user_list()
	{
			...
			$sql1="SELECT a.admin_id 'id' ,a.admin_first_name 'name' 
			from
			pm_admin a
			inner join 
			pm_authorization_rule b
