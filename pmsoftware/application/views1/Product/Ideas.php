									...
									<div class="row " ng-repeat="item in idealist " style="border: 1px solid #ecf0f5;padding: 11px 5px 17px 20px;background: #d1d7de;">
										...
										<div class="col-xs-3 col-centered col-min">
										 ...
										 <li  ng-if="item.Idea_status==3"> <img class="thumb" src="<?php echo base_url();?>images/approved.png" style="width:30px;"/></li>
												...
												<li class="read-more-target"> <b>BSR:</b> {{item.BSR|number : 2}}</li>
										  ...
										  <div>
										   ...
										   <li ng-if="item.design_status==3"><img class="thumb" src="<?php echo base_url();?>images/approved.png" style="width:30px;"/></li>
											 ...
											 <li class="read-more-target">
											  ...
											  <!--<li class="read-more-target"  ng-if="item.color1==1"><b>Colors1:</b>Black</li>
											 <li class="read-more-target" ng-if="item.color1==2"><b>Colors1:</b>Navy</li>
											 <li class="read-more-target"  ng-if="item.color1==3"><b>Colors1:</b>Grey</li>
											  
											  
											   <li class="read-more-target"  ng-if="item.color2==1"><b>Colors2:</b>Black</li>
											 <li class="read-more-target"  ng-if="item.color2==2"><b>Colors2:</b>Navy</li>
											 <li class="read-more-target"  ng-if="item.color2==3"><b>Colors2:</b>Grey</li>
											 
											  <li class="read-more-target"  ng-if="item.color3==1"> <b>Colors3:</b>Black</li>
											 <li class="read-more-target"  ng-if="item.color3==2"><b>Colors3:</b>Navy</li>
											 <li class="read-more-target" ng-if="item.color3==3"><b>Colors3:</b>Grey</li>-->
