    ...
    <section class="sidebar">
	 ...
	 ?>
			 <li class="active treeview" >
			   ...
			   <li><a href="<?php echo base_url();?>index.php/dashboard" <?php if($REQUEST_URI=='/pmsoftware/index.php/dashboard'){?> class="active" <?php }?>><i class="fa fa-dashboard "></i>Dashboard</a>
			   </li>
			   
			   <li <?php if(!(in_array('all',$resource_array) ||  in_array('ManageRole',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/adminroles'){?> class="active" <?php }?> href="<?php echo base_url();?>index.php/adminroles"><i class="fa fa-dashboard "></i>Administrators Roles</a>
			   </li>
			   
			   <li <?php if(!(in_array('all',$resource_array) || in_array('ManageSubAdmin',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/adminuser'){?> class="active" <?php }?> href="<?php echo base_url();?>index.php/adminuser"><i class="fa fa-dashboard "></i>Administrators Users</a>
			   </li>
			   
			    <li <?php if(!(in_array('all',$resource_array) || in_array('IdeasManageUser',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/createproduct'){?> class="active" <?php }?> href="<?php echo base_url();?>index.php/createproduct"><i class="fa fa-dashboard "></i>Ideas</a>
			   </li>
			   
			   <li <?php if(!(in_array('all',$resource_array) || in_array('DesignManageUser',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/createproduct/design_todo_list'){?> class="active" <?php }?> href="<?php echo base_url();?>index.php/createproduct/design_todo_list"><i class="fa fa-dashboard "></i>Design</a>
			   </li>
			   
			    <li <?php if(!(in_array('all',$resource_array) || in_array('CopyWriteManageUser',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/createproduct/copy_todo_list'){?> class="active" <?php }?> href="<?php echo base_url();?>index.php/createproduct/copy_todo_list"><i class="fa fa-dashboard "></i>Copy Writing</a>
			   </li>
			   
			    <li <?php if(!(in_array('all',$resource_array) || in_array('UploadManageUser',$resource_array))){ echo "style='display:none'";}?>><a <?php if($REQUEST_URI=='/pmsoftware/index.php/createproduct/upload_todo_list'){?> class="active" <?php }?>  href="<?php echo base_url();?>index.php/createproduct/upload_todo_list"><i class="fa fa-dashboard "></i>Upload/Status</a>
			   </li>
