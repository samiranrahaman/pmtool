			...
			<div class="row row-centered">
			   ...
			   <div class="row">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" ><a href="<?php echo base_url();?>index.php/adminroles" aria-controls="home" role="tab" >Roles</a>
										</li>
                                        <li role="presentation" class="active"><a href="<?php echo base_url();?>index.php/adminroles/add_role" aria-controls="profile" role="tab" >Add New Role</a></li>
