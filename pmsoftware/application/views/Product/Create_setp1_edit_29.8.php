										   ...
										   <?php  //echo"<pre>";print_r($data);?>
											...
											<div class="col-xs-4 col-centered col-min">
													...
													<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Secondaryword.$invalid && !createproduct.Secondaryword.$pristine }">
														...
														<textarea cols="30" rows="4" maxlength="200"  class="form-control" id="Secondaryword" name="Secondaryword"  ng-model="Secondaryword"></textarea>
  ...
  <script>
        ...
        /*  app.controller('myCtrl', ['$scope', 'fileUpload', function($scope, fileUpload){
             $scope.uploadFile = function(){
               ...
               //var uploadUrl = "<?php echo base_url();?>fileUpload";			   document.getElementById("imgpreview").innerHTML='<img class="thumb" src="<?php echo base_url();?>images/requireimages/Spinner.gif" style="width: 327px;padding: 9px 7px 13px 3px;"/>';
