										   ...
										   <?php  //echo"<pre>";print_r($data);?>
											...
											<div id="image_file"><input type="hidden" class="form-control"  id="Thumbnail" name="Thumbnail" ng-model="Thumbnail" ng-value="Thumbnail" ></div>
												...
												<?php }?>
													...
													<div class="form-group has-feedback" >
														...
														<input  type="number" class="form-control" placeholder="BSR" id="BSR" name="BSR" value="<?php echo $data[0]->BSR;?>" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" >
											...
											<div class="col-xs-4 col-centered col-min">
													...
													<!--<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Secondaryword.$invalid && !createproduct.Secondaryword.$pristine }">
														...
														<textarea cols="30" rows="4" maxlength="200"  class="form-control" id="Secondaryword" name="Secondaryword"  ng-model="Secondaryword"><?php //echo $data[0]->Secondaryword;?></textarea>
													...
													<div class="form-group has-feedback">
														...
														<textarea cols="30" rows="4" maxlength="200"  class="form-control" id="Secondaryword" name="Secondaryword"  ><?php echo $data[0]->Secondaryword;?></textarea>
													...
													<!--<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Notes.$invalid && !createproduct.Notes.$pristine }">
														...
														<textarea cols="30" rows="5" maxlength="200"  class="form-control" id="Notes" name="Notes"  ng-model="Notes"></textarea>
														<p ng-show="createproduct.Notes.$invalid && !createproduct.Notes.$pristine" class="help-block">Field is required.</p>
													</div>-->
													<div class="form-group has-feedback">
														<label for="sel1">Notes :</label>
														
														<textarea cols="30" rows="5" maxlength="200"  class="form-control" id="Notes" name="Notes" ><?php echo $data[0]->Notes;?></textarea>
 ...
 app.controller('productidea',function($scope,$sce,$http){
	 $scope.init=function()
	 {
								 $scope.ideaman="<?php echo $data[0]->idea_man;?>";
								  $scope.merch_account="<?php echo $data[0]->merch_account;?>";
	 ...
	 {   
	    var Thumbnail=document.getElementById("Thumbnail").value;
		 var n = Thumbnail.length; 		 if(n>0)	
			 {
				 //alert($("#Secondaryword").val());
		 $http({
		 method:"post",
								 ...
								 Priority:$scope.Priority,
								  TM_status:$scope.TM_status,
								   ...
								   // Secondaryword:$scope.Secondaryword,
								    Secondaryword:$("#Secondaryword").val(),
