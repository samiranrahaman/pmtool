			...
			<div class="row row-centered">
			    ...
			    <div class="row">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class=""><a  href="#" aria-controls="profile" role="tab" > Uploaded</a>
										</li>
										...
										<table class="table">
											...
											<tbody>
											  ...
											  <tr ng-repeat="item in idealist.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | filter:search || limitTo:itemsPerPage"> 
												...
												<td>
												<!--<a class="btn btn-primary"  href="<?php echo base_url();?>index.php/createproduct/upload_product/{{item.id}}">Upload Product</a>												-->												<a class="btn btn-primary"  href="<?php echo base_url();?>index.php/createproduct/upload_product/{{item.id}}">Upload</a>|												<a class="btn btn-primary"  href="<?php echo base_url();?>index.php/createproduct/upload_product/{{item.id}}">Edit</a>												
												</td>
											  </tr>      
