<div class="content-wrapper" ng-controller="productidea">
    ...
    <section class="content-header">
      <h1>        
        <strong>ToDo Copywrite List</strong>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard"></i>Home</a></li>  
        <li class="active">ToDo Copywrite</li>
      </ol>
      <br/>       
    </section> 
										...
										<table class="table">
											...
											<tbody>
											  ...
											  <tr ng-repeat="item in idealist.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | filter:search || limitTo:itemsPerPage"> 
												...
												<!--<td><img src="<?php echo base_url();?>{{item.Thumbnail}}" style="width:74%;"/>-->												<td ng-if="item.drive_link_to_png!=''">
												...
												<td>
												<a class="btn btn-primary"  href="<?php echo base_url();?>index.php/createproduct/copy_add/{{item.id}}">Add Copy</a>
												</td>
											  </tr>      
 ...
 app.controller("productidea",function($scope,$http,$window){
	 ...
	 $http({
	  method:"post",
	  url:'<?php echo base_url();?>index.php/createproduct/get_idea_list_tocopywrite',
	  headers: {'Content-Type': 'application/x-www-form-urlencoded'}
	 }).success(function(data){
		 console.log(data);
		 $scope.idealist=data;
