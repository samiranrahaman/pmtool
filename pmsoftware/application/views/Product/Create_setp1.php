<div class="content-wrapper" ng-init='init()' ng-controller="productidea">
                                    ...
                                    <div class="tab-content">
										...
										<div class="col-xs-4 col-centered col-min">
											<div class="form-group" ng-controller="myCtrl">
											 ...
											 <button class="btn btn-primary" ng-click = "uploadFile()">Upload New Image</button>-->
										...
										<div class="col-xs-4 col-centered col-min">
										<form  id="createproduct" name="createproduct" ng-submit="productform()" enctype="multipart/form-data" novalidate >
											<div id="image_file"><input type="hidden" class="form-control"  id="Thumbnail" name="Thumbnail" ng-model="Thumbnail" ng-value="Thumbnail" ></div>
											 ...
											 <div class="form-group"  ng-class="{ 'has-error' : createproduct.merch_account.$invalid && !createproduct.merch_account.$pristine }">
											  
														<label for="sel1">Merch Accounts:<span style="color: red;">*</span></label>
														
													 <select class="form-control" id="merch_account" name="merch_account"  required ng-model="merch_account"
														ng-options="opt.id as opt.name for opt in merchlist">
													</select>
													
												<p ng-show="createproduct.merch_account.$invalid && !createproduct.merch_account.$pristine" class="help-block">Field is required.</p>
												</div>
											...
											<?php } else { ?>
												 ...
												 <input ng-init="ideaman=<?php echo $user_info[0]->admin_id?>" type="hidden" class="form-control"  id="ideaman" name="ideaman" ng-model="ideaman" ng-value="ideaman" required>
											...
											<?php }?>
												...
												<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.ideaurl.$invalid && !createproduct.ideaurl.$pristine }">
													...
													<input type="url" class="form-control" placeholder="http://" id="ideaurl" name="ideaurl" ng-model="ideaurl" required> 
											  ...
											  <!--<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.BSR.$invalid && !createproduct.BSR.$pristine }">
													...
													<input type="number" class="form-control" placeholder="BSR" id="BSR" name="BSR" ng-model="BSR" required > 
												...
												<div class="form-group has-feedback">
													...
													<!--<input type="text" class="form-control" placeholder="BSR" id="BSR" name="BSR" ng-model="BSR"  >  -->
													<!--<input  type="number" class="form-control" placeholder="BSR" id="BSR" name="BSR" value="" >-->
													
													<input type="number" class="form-control" placeholder="BSR" id="BSR" name="BSR" value="" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" >
											   ...
											   <div class="form-group"  ng-class="{ 'has-error' : createproduct.TM_status.$invalid && !createproduct.TM_status.$pristine }">
												...
												<div class="form-group has-feedback" >
													...
													<input limit-to="50" type="text" class="form-control" placeholder="Primary Keyword" id="Primaryword" name="Primaryword" ng-model="Primaryword" > 
											...
											<div class="col-xs-4 col-centered col-min">
												...
												<!--<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Primaryword.$invalid && !createproduct.Primaryword.$pristine }">
													...
													<textarea cols="30" rows="5" class="form-control" id="Primaryword" name="Primaryword"  ng-model="Primaryword"></textarea>
												...
												<!--<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Secondaryword.$invalid && !createproduct.Secondaryword.$pristine }">
													<label for="sel1">Secondary Keywords :</label>
													<input type="text" class="form-control" placeholder="Secondary Keyword" id="Secondaryword" name="Secondaryword" ng-model="Secondaryword" > 
												...
												<div class="form-group has-feedback" >
													...
													<textarea cols="30" rows="5" maxlength="256" class="form-control" id="Secondaryword" name="Secondaryword"  ng-model="Secondaryword"></textarea>
												...
												<div class="form-group has-feedback" ng-class="{ 'has-error' : createproduct.Niche_tags.$invalid && !createproduct.Niche_tags.$pristine }">
													...
													<input type="text" class="form-control" placeholder="Niche Tags" id="Niche_tags" name="Niche_tags" ng-model="Niche_tags" > 
											...
											<?php } else { ?>
												 ...
												 <input ng-init="Idea_status=1" type="hidden" class="form-control"  id="Idea_status" name="Idea_status" ng-model="Idea_status" ng-value="Idea_status" required>
											
											<?php }?>
											
											  <div class="form-group" style="margin-top: 19px;">
												<div class="col-xs-4 pull-right">
														<button type="submit" class="btn btn-primary" ng-disabled="createproduct.$invalid">Create </button>
											   </div>
											  </div>
 ...
 app.controller('productidea',function($scope,$http){
	  ...
	  $scope.productform=function()
	 {
		 ...
		 if(n>0)		
			 {
		 //alert($scope.merch_account)
		 $http({
		 method:"post",
		 url:'<?php echo base_url();?>index.php/createproduct/post_product_idea_data',
		 headers: {'Content-Type': 'application/x-www-form-urlencoded'},
		 data :JSON.stringify({ideaman:$scope.ideaman,
							   ideaurl:$scope.ideaurl,
							    merch_account:$scope.merch_account, 
								BSR:$("#BSR").val(),
