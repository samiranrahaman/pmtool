...
class Createproduct extends CI_Controller
{
		     ...
		     $request = json_decode($postdata);
			  ...
			  //echo "<pre>";print_r($request);exit;
			    ...
			    $ideaurl = $request->ideaurl; 
				 $merch_account = $request->merch_account; 
			  ...
			  /* $ideaman = 1; 
			  echo $ideaurl = 'ggg'; */
		     $success=$this->Createproduct_model->post_product_idea_data($ideaman,$merch_account,$ideaurl,$BSR,$Priority,$TM_status,$Primaryword,$Secondaryword,$Niche_tags,$Notes,$Idea_status,$Thumbnail);	
	...
	public function update_product_idea_data()
	{
		     ...
		     $request = json_decode($postdata);
			  ...
			  /* $ideaman = 1; 
			  echo $ideaurl = 'ggg'; */
		     $success=$this->Createproduct_model->update_product_idea_data($ideaman,$merch_account,$ideaurl,$BSR,$Priority,$TM_status,$Primaryword,$Secondaryword,$Niche_tags,$Notes,$Idea_status,$id,$Thumbnail);	
		     echo json_encode($success);
	}
	public function update_product_design_data()
	{
		//echo 1;
		    ...
		    //echo "<pre>"; print_r($request);exit;
		     ...
		     $success=$this->Createproduct_model->update_product_design_data($design_man,$proof_me_link,$fileinfo,$drive_link_to_png,$design_level,$color1,$color2,$color3,$color4,$color5,$design_status,$id,$shirt_type);	
		     echo json_encode($success); 
	}
