...
class Adminuser extends CI_Controller
{
	...
	public function update_add_user()
	{
		     ...
		     $success=$this->Adminuser_model->update_add_user($firstname,$lastname,$phone1,$email,$user_type,$user_id,$password);	
		     echo json_encode($success);
	}
	...
	{
		     $success=$this->Adminuser_model->get_idea_user_list();	
		     echo json_encode($success);
	}
	public function get_designer_user_list()
	{
		     $success=$this->Adminuser_model->get_designer_user_list();	
		     echo json_encode($success);
	}
	public function get_copy_user_list()
	{
		     $success=$this->Adminuser_model->get_copy_user_list();	
		     echo json_encode($success);
	}
	
	public function get_uploader_user_list()
	{
		     $success=$this->Adminuser_model->get_uploader_user_list();	
		     echo json_encode($success);
	}
