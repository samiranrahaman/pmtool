<div class="content-wrapper" ng-controller="productidea">
    ...
    <section class="content-header">
      <h1>        
        <strong>Masterview List</strong>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard"></i>Home</a></li>  
        <li class="active">MasterviewList</li>
      </ol>
      <br/>       
    </section> 
     ...
     <div class="container">
			...
			<div class="row">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation"   ><a  href="<?php echo base_url();?>index.php/createproduct/masterview_list" aria-controls="home" role="tab" >Master View</a>
										</li>
									...
									<div class="row " ng-repeat="item in idealist " style="border: 1px solid #ecf0f5;padding: 11px 5px 17px 20px;background: #d1d7de;">
										...
										<div class="col-xs-2 col-centered col-min"> 
										   ...
										   <div  ng-if="item.Upload_status==1"><img class="thumb" src="<?php echo base_url();?>images/pending.png" style="width:30px;"/></div>
										   <div  ng-if="item.Upload_status==2"><img class="thumb" src="<?php echo base_url();?>images/error.png" style="width:30px;"/></div>
										   <div  ng-if="item.Upload_status==3"><img class="thumb" src="<?php echo base_url();?>images/approved.png" style="width:30px;"/></div>
										   
										   
										   <div><b>Uploader Man:</b> {{item.uploder_first_name}} {{item.uploder_last_name}}</div>
										   <li> <b>Created At:</b>{{item.upload_post_time}}</li>
												<li><b>ProductId:</b>{{item.product_number}}</li>
 ...
 app.controller("productidea",function($scope,$http,$window){
	 $http({
	  method:"post",
	  url:'<?php echo base_url();?>index.php/createproduct/get_masterview_list',
