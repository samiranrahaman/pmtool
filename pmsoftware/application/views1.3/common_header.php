...
<head>
  ...
  <script src="<?php echo base_url();?>js/angularjs_1.4.8_angular.min.js"></script>
   <!--<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.fancybox.min.css" media="screen">-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
  <a href="javascript:void(0);" class="logo" style="background-color: #2f3439;">
