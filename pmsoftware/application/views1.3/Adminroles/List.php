			   ...
			   <div class="row">
                                    ...
                                    <div class="tab-content">
			                            ...
			                            <div class="row table_title" style="">
											  ...
											  <div class="col-sm-8"style="font-size: larger;font-weight: bold;">Name</div>
											   <div class="col-sm-4"style="font-size: larger;font-weight: bold;">Action</div>
											    
										</div>
										<div class="row " ng-repeat="item in roleslist " style="border: 1px solid #ecf0f5;padding: 11px 5px 17px 20px;background: #fff;">
